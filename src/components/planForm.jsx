...
const planForm = ({ data, updateForm }) => {
  return (
    <div className="flex flex-col gap-10 text-left py-10 px-16">
      ...
      <ul className="grid w-full gap-6 md:grid-cols-3 md:max-w-6xl">
      ...
      <div className="bg-gray-100 flex justify-center gap-3 py-3">
        <span class="text-sm font-medium text-Marineblue">Monthly</span>
        <label class="relative inline-flex items-center cursor-pointer">
          <input
            ...
            class="sr-only peer"
          />
          <div class="w-9 h-5 bg-Marineblue peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-Marineblue"></div>
        </label>
        <span class="text-sm font-medium text-gray-400 ">Yearly</span>
      </div>
    </div>
  );
};
