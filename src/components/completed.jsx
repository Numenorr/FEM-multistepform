...
const completed = () => {
  return (
    <div className="flex flex-col text-center items-center gap-9 py-10 px-7 md:px-8 md:max-w-lg">
      <svg
      ...
      <div>
        <h1 className="text-4xl font-bold text-Marineblue mb-5">Thank you!</h1>
